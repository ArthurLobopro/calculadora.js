...
const generatePg = (first_term: number, razion: number, length: number) => {
...
export function PGCalculator(props: calculatorPros) {
    useEffect(() => {
        ...
        if (props.changeTitle) {
            props.changeTitle("Progressão Geométrica")
        }
    }, [])
    ...
    return (
        <div id="pg" className="calculator-wrapper">
            <div className="menu">
...
function Result(props: resultsType[0] & { onDelete?: () => void }) {
    if (props.type === "generate") {
        ...
        const PG = generatePg(first_term, razion, quantity)
        return (
            <div className="res">
                <div>
